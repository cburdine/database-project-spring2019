...
class UnitIdMustBeNumericScreen(Screen):

    screen_name = 'unit_id_must_be_numeric'

    view_kv_filepath = 'screens/unit_id_must_be_numeric_screen.kv'
...
class UnitIdMustBeNumericScreenRoot(Widget):
