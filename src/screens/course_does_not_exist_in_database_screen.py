...
class CourseDoesNotExistScreen(Screen):

    screen_name = 'course_does_not_exist_in_database'

    view_kv_filepath = 'screens/course_does_not_exist_in_database_screen.kv'
...
class CourseDoesNotExistScreenRoot(Widget):
