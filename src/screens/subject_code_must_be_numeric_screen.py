...
class SubjectCodeMustBeNumericScreen(Screen):

    screen_name = 'subject_code_must_be_numeric'

    view_kv_filepath = 'screens/subject_code_must_be_numeric_screen.kv'
...
class SubjectCodeMustBeNumericScreenRoot(Widget):
