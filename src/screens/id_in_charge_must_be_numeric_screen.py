...
class IdInChargeMustBeNumericScreen(Screen):

    screen_name = 'id_in_charge_must_be_numeric'

    view_kv_filepath = 'screens/id_in_charge_must_be_numeric_screen.kv'
...
class IdInChargeMustBeNumericScreenRoot(Widget):
