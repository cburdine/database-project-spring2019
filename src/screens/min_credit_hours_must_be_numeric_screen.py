...
class MinCreditHoursMustBeNumericScreen(Screen):

    screen_name = 'min_credit_hours_must_be_numeric'

    view_kv_filepath = 'screens/min_credit_hours_must_be_numeric_screen.kv'
...
class MinCreditHoursMustBeNumericScreenRoot(Widget):
