...
class NumStudentsMustBeNumericScreen(Screen):

    screen_name = 'num_students_must_be_numeric'

    view_kv_filepath = 'screens/num_students_must_be_numeric_screen.kv'
...
class NumStudentsMustBeNumericScreenRoot(Widget):
