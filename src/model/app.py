...
from src.screens.min_credit_hours_must_be_numeric_screen import MinCreditHoursMustBeNumericScreen
from src.screens.id_in_charge_must_be_numeric_screen import IdInChargeMustBeNumericScreen
...
class CurriculaApp(App):
    ...
    def build(self):
        ...
        screen_list.append(MinCreditHoursMustBeNumericScreen(root_app=self))
        screen_list.append(IdInChargeMustBeNumericScreen(root_app=self))
